...
class ManualStemmer:
    ...
    def _create_hindi_rules(self) -> List[Tuple[str, str]]:
        ...
        rules = [
            # Plural suffixes
            ('ियाँ$', 'ी'),  # लड़कियाँ -> लड़की
            ('ियों$', 'ी'),  # लड़कियों -> लड़की
            ('ों$', ''),    # बच्चों -> बच्च
            ('ें$', ''),    # औरतें -> औरत
            ('ियां$', 'ी'), # लड़कियां -> लड़की
            ('ाओं$', 'ा'),  # बहुओं -> बहू
            ('ाएँ$', 'ा'),  # बहुएँ -> बहू
            ...
            # Adjective forms
            ('वान$', ''),  # गुणवान -> गुण
            ('मान$', ''),  # बुद्धिमान -> बुद्धि
            ('दार$', ''),  # जिम्मेदार -> जिम्मे
            ('कार$', ''),  # सुस्कार -> सुस्
            ('हार$', ''),  # पहनहार -> पहन
            ('वाला$', ''),  # पढ़नेवाला -> पढ़ने
            ('वाले$', ''),  # पढ़नेवाले -> पढ़ने
            ('वाली$', ''),  # पढ़नेवाली -> पढ़ने
    ...
    def _create_marathi_rules(self) -> List[Tuple[str, str]]:
        ...
        rules = [
            ...
            ('ांचा$', ''),  # मुलांचा -> मुल
            ('ांची$', ''),  # मुलांची -> मुल
            ('ांच्या$', ''),  # मुलांच्या -> मुल
            ('ांमध्ये$', ''),  # मुलांमध्ये -> मुल
            ('ांसाठी$', ''),  # मुलांसाठी -> मुल
...
def main():
    ...
    hindi_text = """विभ क ा ट क न ल ज म बई (VIT म बई) भ रत क  एक प रख य त तक न क स स थ न ह । 
...
सम ध न ख जन  म अग रण रह  ह ।"""
    ...
    marathi_text = """विभ क ा ट क न ल ज म बई (VIT म बई) ह  भ रत त ल एक प रख य त तक न क 
